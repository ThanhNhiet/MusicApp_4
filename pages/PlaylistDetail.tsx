...
export default function PlaylistDetail({ navigateToHome }: any) {
    ...
    const songs = [
        { id: "1", title: "FLOWER", artist: "Jessica Gonzalez", duration: "03:36", image: "../assets/images/Playlist Details - Audio Listing/Image 51.png", Listens: "2.1M" },
        { id: "2", title: "Shape of you", artist: "Anthony Taylor", duration: "03:35", image: "../assets/images/Playlist Details - Audio Listing/Image 52.png", Listens: "68M" },
        { id: "3", title: "Blinding Lights", artist: "Brian Bailey", duration: "04:39", image: "../assets/images/Playlist Details - Audio Listing/Image 53.png", Listens: "93M" },
        { id: "4", title: "Levitating", artist: "Anthony Taylor", duration: "07:48", image: "../assets/images/Playlist Details - Audio Listing/Image 54.png", Listens: "9M" },
        { id: "5", title: "Astronaut in the Ocean", artist: "Pedro Moreno", duration: "03:36", image: "../assets/images/Playlist Details - Audio Listing/Image 55.png", Listens: "23M" },
        { id: "6", title: "Dynamine", artist: "Elena Jimenez", duration: "06:22", image: "../assets/images/Playlist Details - Audio Listing/Image 56.png", Listens: "10M" }
    ];
        ...
        <View style={styles.container}>
            <ScrollView style={styles.scrollcontainer}>
                ...
                <View style={styles.containerPlay}>
                    <View style={{ flexDirection: 'row' }}>  {/* Gói 2 icon đầu vào một View */}
                        <TouchableOpacity>
                    ...
                    <View style={{ flexDirection: 'row' }}> {/* Gói 2 icon cuối vào một View */}
                        <TouchableOpacity>
